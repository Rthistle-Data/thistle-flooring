# Sharper website logo

Created with the built-in image-generation tool from `assets/images/logo-wide.png`. The original files are preserved. Final website asset: `assets/images/logo-sharp.png`.

Initial prompt: Preserve the purple thistle, green leaves, wood flooring planks, script Thistle wordmark, uppercase FLOORING, and wood swoosh. Remove blurry glow and haze, sharpen edges, simplify fine detail for small sizes, and use ivory Thistle lettering with gold FLOORING lettering for contrast on forest green. Request a tightly framed wide PNG.
